# Operator Quickstart — Community Household Goods Rental Operations

Shortest path from clone to a verified local dry-run for **ISIC 7729** (`cloud-itonami-isic-7729`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7729.git
cd cloud-itonami-isic-7729
```
...
- Blueprint governor key: `household-rental-governor`
- Likely source path: `src/**/household-rental-governor.cljc`
