...
`cloud-itonami-7729` accepts contributions to the OSS blueprint, capability
...
- Keep robot dispatch and reconciliation records behind the
  Household Rental Governor.
- Treat agreement-release/delivery workflows as high-risk: add tests
  for robot-safety gating, disclosure scope, evidence, disclosure and
  audit logging.
